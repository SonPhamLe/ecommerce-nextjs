...
export default function Checkout() {
  ...
  const publishableKey =
    "pk_test_51OodvCCoCUyzDECEzOyYAcElpNunIluyrOulKoyq1RWBMpOI8CsWtBUPN0jcf93biKjl3mqWDk5C8Nh08Ldo6XNl003s46lpGZ";
    ...
    <div>
      <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
        <div className="px-4 pt-8">
          <p className="text-gray-900 font-bold text-xl">Cart Summary</p>
            ...
            {cartItems && cartItems.length ? (
              cartItems.map((item) => (
                ...
                >
                  ...
                  />
                  <div className="text-gray-900 flex w-full flex-col px-4 py-4">
        ...
        <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
          <p className="text-gray-900 text-xl font-bold">Shipping address details</p>
          <p className="text-gray-400 font-bold">
            Complete your order by selecting address below
          </p>
          <div className="text-gray-900 w-full mt-6 mr-0 mb-0 ml-0 space-y-6">
